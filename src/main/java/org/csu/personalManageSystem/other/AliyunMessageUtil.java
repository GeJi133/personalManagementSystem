...
public class AliyunMessageUtil {
    ...
    private static final String accessKeyId = "LTAI4FrkPUYxG2QxKpPHjrBx";
    private static final String accessKeySecret = "oetTMewv8aFT8IPQq4LFwBidSlmGG8";
    public static SendSmsResponse sendSms(Map<String, String> paramMap) throws com.aliyuncs.exceptions.ClientException {
        ...
        System.out.println (paramMap.get("phoneNumber"));
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(paramMap.get("msgSign"));
        System.out.println (paramMap.get("msgSign"));
        //必填:短信模板-可在短信控制台中找到
        System.out.println (paramMap.get("templateCode"));
